...
## - how HTML tags are nested within eachother: button in anchor in un-ordered list,

Confusing:

## - had to be thoughtful about changes in HTML that would break CSS like re-naming the class when I changed the images

- [ x ] Customize the template to you - [ x ] Update the title tag match your name - [ ] Update the place holder content throughout the template to your information
